  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        将成交顺序随机打乱 {mc.n_simulations.toLocaleString()} 次,检验夏普是否优于随机结果。
      </p>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <Badge value={reliable ? "区间 > 0" : "区间含 0"} good={reliable} />
      </div>
      <p className="text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 rounded-xl border border-border/60 bg-muted/20 p-3">
        ...
        <Stat label="中位夏普" value={bs.median_sharpe.toFixed(2)} />
      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="border-b text-left text-muted-foreground">
            ...
            <th className="py-1.5 pr-3 text-right">成交</th>
